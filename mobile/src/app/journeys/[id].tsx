...
const s = StyleSheet.create({
  ...
  pos: { fontFamily: mono, fontSize: 14, color: colors.gold, width: 22, textAlign: "center" },
  ...
  confirmYes: { backgroundColor: colors.danger, borderRadius: 8, paddingVertical: 11, paddingHorizontal: 22 },
